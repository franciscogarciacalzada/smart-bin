...
<html>
	...
	<body>
 		<center><h1 class="title is-1">Smart Bin</h1></center><br>
...
<script type="text/javascript">					
	...
	//Grafico Humedad & Temperatura
	var chartHuTe =  Highcharts.chart('container-h_t', {
		chart: {
			type: 'line'
		},
		title: {
			text: 'Temperatura y humedad del contenedor a cada hora'
		},
		xAxis: {
    ...
    title: {
        text: 'Uso del contenedor a cada hora'
    },
    legend: {
        layout: 'vertical',
        align: 'left',
	...
	var chartLvlTime = Highcharts.chart('container-lvl_time', {
		...
		title: {
			text: 'Nivel de la basura a cada hora'
		},
		xAxis: {
